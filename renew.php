<?php
    ...
    if(isset($_POST['id'])){
        ...
        $result = mysqli_query($link,"select * from pass where id = '$id'");
		$row = mysqli_fetch_array($result);
		
		mysqli_query($link,"UPDATE pass SET date = '$new_date' WHERE id = '$id'");
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="index.html" class="text-black h2 mb-0">Travellers</a></h1>
          </div>
          ...
          <div class="col-50">
            ...
            <div class="icon-container">
			  ...
			  <div>Rs. 
				<?php
					$dest = $row['dest'];
					$price = mysqli_fetch_assoc(mysqli_query($link,"select price from destination where name = '$dest'"))['price'];
					$amt = $price * $nod;
					echo $amt;
				?>
			  </div>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">About Travellers</h3>
